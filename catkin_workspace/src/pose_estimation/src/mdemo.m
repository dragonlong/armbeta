...
toolboxPath = '../../../toolbox'; % Directory of toolbox utilities
...
figure(1)
subplot(2,2,1);
pcshow(emptyToteModel);
title("empty tote model");
...
for resultIdx = 1:length(resultFiles)
    ...
    tmpResult.objPoseWorld(1:3,1:3) = quat2rot([objPoseRotQuat(4),objPoseRotQuat(1:3)]);
